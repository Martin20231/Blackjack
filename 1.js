...
function klick_weiß(){
    ...
    einsatz_geld_cpu = einsatz_geld_cpu + summeChips;
    ...
    document.getElementById("geld_einsatz_cpu").innerHTML = "Geld:</br>" + einsatz_geld_cpu +"€";
...
function start_function(){
    ...
    let random_variant_spieler2 = Math.floor(Math.random() * variant.length);
    let random_wert_spieler2 = Math.floor(Math.random() * werte.length) ;
    ...
    function klicke_hit() {
        //Card Spieler
        let card_spieler2 = [
            variant[random_variant_spieler2],
            werte[random_wert_spieler2]
        ]
        deck_spieler2.push(card_spieler2);
    }
    if (onclick=klicke_hit()){   
    let p1 = werte_rechner(deck_spieler,punkte_spieler);
    let p2 = werte_rechner(deck_spieler1,punkte_spieler1);
    let p3 = werte_rechner(deck_spieler1,punkte_spieler1);
    gesamt_spieler = p1 + p2 + p3;
    ...
    //Eingesetzes Geld wieder auf null
    ...
    if (gesamt_spieler > gesamt_cpu){
        ...
        chipGesamtStart_spieler = chipGesamtStart_spieler  + einsatz_geld + einsatz_geld_cpu;
        document.getElementById("geld_spieler").innerHTML = "Geld:</br>" + chipGesamtStart_spieler +"€";
        einsatz_geld = 0;
        document.getElementById("geld_einsatz_spieler").innerHTML = "Geld:</br>" + einsatz_geld +"€";  
    }
